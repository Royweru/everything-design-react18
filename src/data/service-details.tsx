...
export const images = [
  ...
  {
    src: "https://img.freepik.com/premium-vector/creative-abstract-background_17005-111.jpg?w=740",
    width: 300,
    height: 500,
  },
  {
    src: "https://img.freepik.com/free-photo/portrait-woman-representing-virgo-zodiac-sign_23-2151006277.jpg?t=st=1715414298~exp=1715417898~hmac=5b9506f7e40f998ab19d58d0d51b58ff8ac63efae09347c31db9a9f24ba08560&w=360",
    width: 500,
    height: 350,
  },
  {
    src: "https://img.freepik.com/free-photo/auto-outdoors-portrait-girl-looking_1304-939.jpg?t=st=1715414326~exp=1715417926~hmac=f4fd5b8b96dcac4e22c75db9c9471e120b99f64278039563ed4e35b3ddb6cf32&w=900",
    width: 200,
    height: 200,
  },
  {
    src: "https://img.freepik.com/free-photo/portrait-two-friends-2000s-fashion-style-posing-together-with-tv-camera_23-2149442847.jpg?t=st=1715415163~exp=1715418763~hmac=72e8945417b3131ca4650eec5371f64a8e919621829cf7b4296dce4b62f1140f&w=360",
    width: 450,
    height: 400,
  },
...
export const ServiceDetails: {
  ...
  {
    id: 1,
    icon: <FaMugHot className="  w-24 h-24 text-color-2 font-bold" />,
  ...
  {
    id: 2,
    icon: <FaPalette className=" w-24 h-24 text-color-2 font-bold" />,
  ...
  {
    id: 3,
    icon: <FaInstagram className=" w-24 h-24 text-color-2 font-bold" />,
